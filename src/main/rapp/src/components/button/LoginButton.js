                        ...
                        <div className={"modal-body"}>
                            ...
                            {this.state.type === "login" && (
                                <Login
                                    ...
                                    passwordLabelHandler={
                                        this.passwordLabelHandler
                                    }
                            ...
                            {this.state.type === "register" && (
                                <Register
                                    ...
                                    repPasswordLabelHandler={
                                        this.repPasswordLabelHandler
                                    }
                                    errorEmailHandler={this.errorEmailHandler}
                                    errorPasswordHandler={
                                        this.errorPasswordHandler
                                    ...
                                    errorRepPasswordHandler={
                                        this.errorRepPasswordHandler
                                    }
                                    errorEmail={this.state.errorEmail}
                                    errorPassword={this.state.errorPassword}
                                    errorRepPassword={
                                        this.state.errorRepPassword
                                    }
                                />
                            )}
                            {this.state.type === "recover" && (
